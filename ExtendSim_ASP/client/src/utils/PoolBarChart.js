...
class PoolBarChart extends React.Component {
    ...
    render() {
        ...
        if ((chartType === "idle-busy") && (this.state.selectedChartType !== chartType)) {
            ...
            this.setState({ chartTitle: 'Total Idle-Time/Total Busy-Time by Pool',
                            YaxisTitle: 'Time (hrs)',
                            XaxisTitle: 'Pools',
                            dataSeries1: poolChartData.TotalBusyTime,
                            dataSeries2: poolChartData.TotalIdleTime,
            ...
            this.setState({ chartTitle: 'Utilization by Pool',
                            YaxisTitle: 'Utilization',
                            XaxisTitle: 'Pools',
                            dataSeries1: poolChartData.Utilization,
                            dataSeriesLabels: dataSeriesLabels,
                            dataSeriesDisplay: dataSeriesDisplay,
                            dataSeriesBorderWidths: dataSeriesBorderWidths,
                            dataSeriesBackgroundColors: dataSeriesBackgroundColors,
            ...
            dataSeriesBackgroundColors[1] = 'rgba(0, 0, 0, 0)';
            this.setState({ chartTitle: 'Total Orders Serviced by Pool',
                            YaxisTitle: 'Orders Serviced',
                            XaxisTitle: 'Pools',
                            dataSeries1: poolChartData.TotalOrdersServiced,
                            dataSeriesLabels: dataSeriesLabels,
                            dataSeriesDisplay: dataSeriesDisplay,
                            dataSeriesBorderWidths: dataSeriesBorderWidths,
                            dataSeriesBackgroundColors: dataSeriesBackgroundColors,
